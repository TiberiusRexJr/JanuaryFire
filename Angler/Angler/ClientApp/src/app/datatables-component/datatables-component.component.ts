...
@Component({
  selector: 'app-datatables-component',
  templateUrl: './datatables-component.component.html',
  styleUrls: ['./datatables-component.component.scss']
})

export class DatatablesComponentComponent implements OnInit,AfterViewInit {
